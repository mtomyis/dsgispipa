            ...
            <div class="row mt">
                ...
                <div class="col-lg-12">
                    <div class="content-panel">
                        ...
                        <h4><a href="indextandon_add.php?idh=<?php echo $_GET['id'] ?>" class="btn btn-success">Tambah Tandon</a></h4>
                        <section id="unseen">
                            <table id="tablehippam" class="display table table-bordered">
                                <thead>
                                    <tr>
                                        <th width="5%">No.</th>
                                        <th width="25%">Nama tandon</td>
                                ...
                                <tbody>
                                    ...
                                    $id = $_GET['id'];
                                    $no = 0;
                                    $sql = "SELECT BP.*,HP.nama as hp_nama FROM tandon BP
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="tooltip-demo" align="center">
                                                <a href='<?php echo 'indextandon_edit.php?id=' . $dat['id']; ?>' title="Ubah Data" rel="tooltip">
