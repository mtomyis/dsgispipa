...
<html lang="en">
  ...
  <section id="main-content">
    ...
    <h3><i class="fa fa-angle-right"></i> Edit Hippam</h3>
      <div id="status">
              ...
              <!-- START FORM TAMBAH DATA -->
                ...
                $(document).ready(function() { 
                    $("#addForm").submit(function(e) {
                        e.preventDefault();
                        // var datatosend = new FormData('#addForm');
                        // Get form
                        var form = $('#addForm')[0];
                ...
                <ul class="nav nav-tabs" role="tablist" style="margin-top:5px;">
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="data_umum">
                      <!-- mulai panel isian-->
                      <form action="../hippam/hippam_proc.php" method="POST" name="addForm" id="addForm" class="form-horizontal" enctype="multipart/form-data" accept-charset="multipart/form-data">
                        ...
                        <div class="panel panel-info">
                          ...
                          <div id="isian_data" class="panel-collapse collapse">
                            <div class="panel-body">
                              ...
                              <div class="form-group">
                                <label for="file" class="col-sm-2 control-label">Gambar</label><br>
                                <img width="50%" height="50%" src="https://dspipabangorejo.konseparsitek.com/assets/upload/<?=$dat_hippam['gambar']?>" />
                                <div class="col-sm-3">
                                  <input type="hidden" name="gambarold" id="gambarold"value="<?=$dat_hippam['gambar']?>">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                  <input type="text" name="latitude" id="latitude" class="form-control" value="<?php echo $dat_hippam['latitude'];?>" data-bv-notempty data-bv-numeric>
                                </div>
                              </div>
                              <div class="form-group">
                                <label for="" class="col-sm-1 control-label">Longitude</label>
                                <div class="col-sm-5">
                                  <input type="text" name="longitude" id="longitude" class="form-control" value="<?php echo $dat_hippam['longitude'];?>" data-bv-notempty data-bv-numeric>
                                </div>
                              </div>
...
function show_data(id){//alert(id);
  $("#"+id).load("../hippam/hippam_proc.php", { hippam_id: "<?=$dat_hippam['id'];?>", place: id ,action:"show_data"} );
}
</script>
