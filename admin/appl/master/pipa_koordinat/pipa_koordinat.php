    ...
    <?php include $doc_template.'menu_top.php';?>   
     ...
     <div class="container-fluid">
              ...
              <form name="search_form" act="<?php echo $_SERVER['PHP_SELF'];?>" method="GET" class="form-inline pull-right" role="form">
                ...
                <div class="input-group">
                  ...
                  <?php
                    ...
                    $attr = array('sql'=>$sql_hippam,'name'=>'hippam_id','id'=>'hippam_id','value'=>$hippam_id,'option_all'=>true);
         ...
         <div class="row">
            ...
            <?php            
                $pgn->sql_all = "SELECT PP.*,HP.nama as hp_nama 
                                FROM pipa PP
                                JOIN pipa_jenis PJ ON PP.pipa_jenis_id=PJ.id
             ...
             <div class="col-md-12">
               <div class="table-responsive">
                  <table class="table table-bordered table-condensed table-heading">
                    ...
                    <tbody>
                    <?php
                      $sql = $pgn->sql_all." ORDER BY PJ.id,PP.nama LIMIT $pgn->start,$pgn->dataperpage";
                      $data = $db->fetchdata($sql);
                      foreach($data as $dat){
                    ?>
                      <tr>
                        <td class="tooltip-demo" align="center">
                            <a href='<?php echo 'pipa_koordinat_detail.php?id='.$dat['id'];?>' title="Ubah Data" rel="tooltip">
