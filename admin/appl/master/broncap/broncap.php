    ...
    <?php include $doc_template.'menu_top.php';?>   
     ...
     <div class="container-fluid">
              ...
              <form name="search_form" act="<?php echo $_SERVER['PHP_SELF'];?>" method="GET" class="form-inline pull-right" role="form">
                ...
                <div class="input-group">
                  ...
                  <?php
                    ...
                    $attr = array('sql'=>$sql_hippam,'name'=>'hippam_id','id'=>'hippam_id','class'=>'form-control','option_all'=>true);
         ...
         <div class="row">
            ...
            <?php            
                $pgn->sql_all = "SELECT BP.*,HP.nama as hp_nama FROM broncap BP
                                JOIN hippam HP ON BP.hippam_id=HP.id
                                WHERE BP.nama LIKE '%$nama%'
                  ...
                  <table class="table table-bordered table-condensed table-heading">
                    <thead>
                      <tr>
                          ...
                          <th width="25%">Nama</td>
                          <th width="25%">Latitude</td>
                          <th width="25%">Longitude</td>
                          <th width="25%">Keterangan</td>
                      </tr>
                    </thead>
                    <tbody>
                    <?php
                      $sql = $pgn->sql_all." ORDER BY BP.nama LIMIT $pgn->start,$pgn->dataperpage";
                      $data = $db->fetchdata($sql);
                      foreach($data as $dat){
                    ?>
                      <tr>
                        <td class="tooltip-demo" align="center">
                            <a href='<?php echo 'broncap_detail.php?id='.$dat['id'];?>' title="Ubah Data" rel="tooltip">
