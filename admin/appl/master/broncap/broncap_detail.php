...
<?php
    $id = $_GET['id'];
    $sql = "SELECT * FROM broncap WHERE id='$id'";
    $dat_broncap = $db->datasql($sql);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
              ...
              <div class="col-md-12">
                  <form action="broncap_proc.php" method="POST" name="addForm" id="addForm" class="well form-horizontal">
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
                        <?php
                          ...
                          $attr = array('sql'=>$sql_hippam,'name'=>'hippam_id','id'=>'hippam_id','class'=>'form-control','value'=>$dat_broncap['hippam_id']);
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" name="nama" id="nama" class="form-control" value="<?php echo $dat_broncap['nama'];?>" data-bv-notempty>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-1 control-label">Latitude</label>
                      <div class="col-sm-5">
                        <input type="text" name="latitude" id="latitude" class="form-control" value="<?php echo $dat_broncap['latitude'];?>" data-bv-notempty data-bv-numeric>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-1 control-label">Longitude</label>
                      <div class="col-sm-5">
                        <input type="text" name="longitude" id="longitude" class="form-control" value="<?php echo $dat_broncap['longitude'];?>" data-bv-notempty data-bv-numeric>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-1 control-label">Keterangan</label>
                      <div class="col-sm-5">
                        <textarea name="keterangan" rows="2" id="keterangan" class="form-control"><?php echo $dat_broncap['keterangan'];?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-sm-offset-1 col-sm-5">
                        ...
                        <input type="hidden" name="id" value="<?php echo $dat_broncap['id']; ?>">
                      </div>
                    </div>
                  </form>
              </div>
