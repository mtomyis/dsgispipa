        ...
        <tr>
          <td bgcolor="#FFFFFF" class="JudulVerdana4"><div align="left">
            <table width="100%" border="0" cellpadding="2" cellspacing="1" >
              <tr>
                <td width="63%"><div align="left" class="popup_title">DAFTAR GURU</div></td>
                </tr>
            </table>
          </div></td>
        </tr>
                        ...
                        <?php
                            ...
                            if($act == "cari"){
                                ...
                                if($page<1)
                                        $page=1;
                                $i=0;
                                $sql_all="SELECT * FROM guru WHERE aktif='1' AND nama LIKE '%$nama%' ";
              ...
              <input name="nama" type="hidden" id="nama" value="<?php echo $nama;?>" />
                      ...
                      <table class="table table-striped table-bordered table-condensed">
                          ...
                          <tr valign="top" style="cursor: pointer;" 
                              onclick="
                                    opener.document.myform.guru_id.value='<?php echo $dat['id'];?>'; 
                                    opener.document.myform.guru_nama.value='<?php echo $dat['nama'];?>'; 
                                    self.close()"" >
