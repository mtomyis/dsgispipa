        ...
        <tr>
          <td bgcolor="#FFFFFF" class="JudulVerdana4"><div align="left">
            <table width="100%" border="0" cellpadding="2" cellspacing="1" >
              <tr>
                <td width="63%"><div align="left" class="popup_title">DAFTAR SISWA</div></td>
                </tr>
            </table>
          </div></td>
        </tr>
                  ...
                  <tr>
                    <td valign="middle" align="left" class="JudulVer2">
                      ...
                      <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" name="form1" id="form1">
                        No. induk
                        <input name="kode" type="text" id="kode" value="<?php echo $kode;?>" class="input-medium" />
                        Nama 
                        ...
                        <?php
                            ...
                            if($act == "cari"){
                                ...
                                if($page<1)
                                        $page=1;
                                $i=0;
                                $sql_all="SELECT * FROM siswa WHERE aktif='1' AND nama LIKE '%$nama%' AND nis LIKE '%$kode%' ";
              ...
              <input name="kode" type="hidden" id="kode" value="<?php echo $kode;?>" />
                      ...
                      <table class="table table-striped table-bordered table-condensed">
                          ...
                          <tr valign="top" style="cursor: pointer;" 
                              onclick="
                                    opener.document.myform.siswa_id.value='<?php echo $dat['id'];?>'; 
                                    opener.document.myform.siswa_nis.value='<?php echo $dat['nis'];?>'; 
                                    opener.document.myform.siswa_nama.value='<?php echo $dat['nama'];?>'; 
                                    self.close()"" >
                            <td align="right"><?php echo $no = $start + $i;?>.&nbsp;</td>
                            <td><div align="left">  <?php echo $dat['nis']; ?></div></td>
